...
var video_courses = document.getElementById('video-courses');
var our_employees = document.getElementById('our-employees');
...
fl_slide_with_three_elements(video_courses, true, "slow");
flash_post_slide(our_employees, true, "normal", true, true);
